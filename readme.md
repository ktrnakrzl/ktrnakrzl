...
**Python** • **Dart** • **Java** • **Bash** • **PyTorch** • **SBERT** • **FAISS** • **SymPy** • **SciPy** • **NumPy** • **Phi-3 Mini** • **T5** • **Google ML Kit** • **Pix2tex** • **AWS (EC2)** • **Docker** • **Supabase** • **pgvector** • **FastAPI** • **PostgreSQL** • **MySQL** • **RESTful APIs** • **Linux** • **Kali Linux** • **Wireshark** • **Nmap** • **SQLmap** • **OSINT** • **SIEM (Splunk)** • **MITRE ATT&CK** • **Threat Hunting** • **Blue Team Operations** • **Git** • **GitHub** • **Bash Scripting** • **Linux Administration** • **System Design**
